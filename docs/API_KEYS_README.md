...
In [main.ipynb](../main.ipynb), find the "API Key Configuration" cell and uncomment the lines:
...
**Note**: Google Gemini and all other models are accessed via OpenRouter and do not require separate API keys.
